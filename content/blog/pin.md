---
title: "pin: A Small CLI Spinner for Go"
summary: "pin is a Go spinner with colors, prefixes, message updates, pipe detection, and no external dependencies. It exists because a spinner should not drag a UI framework into a small CLI."
postLayout: simple
date: "2025-02-10"
tags:
  - go
...
The source is on GitHub: [github.com/yarlson/pin](https://github.com/yarlson/pin). It's small enough that you can read the whole thing in one sitting.
